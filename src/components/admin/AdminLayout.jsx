...
import QuoteBell from "./QuoteBell";
  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="flex items-center gap-3 border-b border-border bg-white px-4 py-3 sm:px-8">
          <button
            onClick={() => setSidebarOpen(true)}
            className="rounded-lg border border-border p-2 text-foreground/70 hover:bg-secondary lg:hidden"
          >
          ...
          <p className="hidden text-sm font-medium text-muted-foreground lg:block">Painel administrativo</p>
