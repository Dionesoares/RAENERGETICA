...
import { ClipboardList, LogOut, Wrench, X } from "lucide-react";
import { useAuth } from "@/lib/AuthContext";
import Logo from "@/components/ra/Logo";

const items = [
  { label: "Chamados", to: "/tecnico", icon: Wrench, end: true },
  { label: "Relatórios", to: "/tecnico/relatorios", icon: ClipboardList },
];

export default function TecnicoSidebar({ open, onClose }) {
    ...
    <>
      ...
      >
        <div className="mb-8 flex items-center justify-between px-2">
          <div>
            <Logo tiny />
            <p className="mt-1 text-xs text-muted-foreground">Suporte Técnico</p>
          </div>
